...
public class PrintNationalShipment {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        Shipment shipment = ShipmentDataProvider.createNationalShipment();
        shipment.setSelectedRateCode("dpd_national_dropoff");
        ...
        LOG.info(MessageFormat.format("Responsestatus: {0}", labelResponse.getStatus()));
